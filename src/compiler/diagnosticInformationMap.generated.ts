...
namespace ts {
    export var Diagnostics = {
        ...
        Enable_or_disable_iterables_language_feature: { code: 6073, category: DiagnosticCategory.Message, key: "Enable or disable 'iterables' language feature" },
        Enable_or_disable_for_of_language_feature: { code: 6074, category: DiagnosticCategory.Message, key: "Enable or disable 'for..of' language feature" },
        Enable_or_disable_generators_language_feature: { code: 6075, category: DiagnosticCategory.Message, key: "Enable or disable 'generators' language feature" },
